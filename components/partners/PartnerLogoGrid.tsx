...
const PartnerLogoGrid = () => {
	return (
		<section className='px-10 bg-[url(/images/texture-bg-full.png)] bg-blend-overlay bg-center bg-cover bg-[#0A74EF] py-20'>
			<h3 className='text-[2.5rem] text-white font-medium tracking-[1.6px] text-center mb-20'>
				Brands Who Support Our Vision
			</h3>
			<div className='max-w-350 flex-wrap justify-center items-center mx-auto gap-[3.75rem_2.5rem] flex'>
				{[
					'toyow',
					'nest',
					'mansa',
